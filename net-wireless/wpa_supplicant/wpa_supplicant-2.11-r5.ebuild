...
SLOT="0"
IUSE="+ap broadcom-sta dbus eap-sim eapol-test +fils gui macsec +mbo +mlo +mesh p2p privsep readline selinux smartcard tkip uncommon-eap-types wep wps"
...
src_configure() {
	...
	if use mlo ; then
		...
		Kconfig_style config IEEE80211AX
	else
		Kconfig_style_config IEEE80211BE n
	fi
